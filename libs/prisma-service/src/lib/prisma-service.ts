  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  private handlePrismaError(
    ...
    if (error instanceof Prisma.PrismaClientKnownRequestError) {
      ...
      let userMessage = 'An error occurred. Please try again.'; // You can still use let for userMessage

      switch (error.code) {
        case 'P2002': {
          const violatedField = this.extractFieldFromErrorMessage(
            error.message,
          );
        ...
        case 'P2003': {
          ...
          userMessage =
            'Related record not found. Please ensure related data is valid.';
        ...
        case 'P2025': {
          ...
          userMessage =
            'The requested record could not be found. Please check your input.';
        ...
        case 'P2026': {
          ...
          userMessage =
            'Multiple records returned when only one was expected. Please verify your query.';
      ...
      throw new InternalServerErrorException(
        'Unknown issue with the database connection.',
        error.message,
      );
    } else {
